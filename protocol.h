...
class Proto
{
    public:
        Proto(Serial *ps);
        // Alive RF ping
        void rf_get_tx_alive_3B(uint8_t NodeId, uint8_t* tx_data);
        void rx_alive(uint8_t src_NodeId);//Rx 3 Bytes

        // Reset
        void rf_get_tx_reset_3B(uint8_t NodeId, uint8_t* tx_data);
